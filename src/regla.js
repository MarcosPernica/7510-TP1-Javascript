...
var Regla = function (regla) {
	...
	this.normalizarRegla = function(regla)
	{
		var n = new RegExp("\n{1,}",'g');
		...
		regla = regla.replace(n,"");
		regla = regla.replace(t,"");
		regla = regla.replace(s,"");
		regla = regla.replace(p,"");
	...
	this.reglaNormalizada = this.normalizarRegla(regla);
